...
import com.karrydev.peacock.ui.NewMainActivity
import com.karrydev.peacock.util.appContext
import com.karrydev.peacock.util.appName
...
class ForegroundService : Service() {
    ...
    companion object {
        ...
        const val CHANNEL_ID = "Peacock_Channel_ID"
    ...
    private fun createNotification(): Notification {
        // 设置通知的点击跳转
        val serviceIntent = Intent(this, NewMainActivity::class.java)
